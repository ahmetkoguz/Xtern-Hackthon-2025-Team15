...
export default function SimpleChef() {
  ...
  // Color mapping
  const buttonData = [
    { label: 'Recipes', icon: <RestaurantMenuIcon fontSize="large" />, bg: '#d1b3ff' },
    { label: 'Safety', icon: <SecurityIcon fontSize="large" />, bg: '#a4f9a4' },
    { label: 'Settings', icon: <SettingsIcon fontSize="large" />, bg: '#dddddd', onClick: () => setOpenSettings(true)},
    { label: 'Sleep Mode', icon: <NightsStayIcon fontSize="large" />, bg: '#a0c4ff' },
    { label: 'Ingredients', icon: <ShoppingBasketIcon fontSize="large" />, bg: '#fddf92' },
    { label: 'Conversions', icon: <StraightenIcon fontSize="large" />, bg: '#f9a8d4' },
  ];
  return (
